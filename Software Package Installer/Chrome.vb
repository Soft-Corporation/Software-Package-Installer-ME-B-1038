...
Public Class Chrome
    ...
    Private Sub Chrome_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ProgressBar1.Show()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_aea34adbbf5840ffa658e6063152acff.zip"), Texbbb.TextBox5.Text)
