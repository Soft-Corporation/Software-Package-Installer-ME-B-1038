...
Public Class OperaCB
    ...
    Private Sub OperaCB_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_9f837aecfb2c4b919160031b78540e00.zip"), Texbbb.TextBox34.Text)
        Timer1.Start()
