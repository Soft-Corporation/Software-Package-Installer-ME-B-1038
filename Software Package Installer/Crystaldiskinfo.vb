...
Public Class Crystaldiskinfo
    ...
    End Sub
    Private Sub Crystaldiskinfo_Load(sender As Object, e As EventArgs) Handles MyBase.Load



        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_2cced8360fcc4837b8ea9efb059565bb.zip"), Texbbb.TextBox48.Text)
