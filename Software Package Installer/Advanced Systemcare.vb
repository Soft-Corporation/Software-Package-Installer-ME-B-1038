...
Public Class Advanced_Systemcare
    ...
    Private Sub Advanced_Systemcare_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        downlaod.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_659a1b602e214ae0b8e2b4876f51de0d.zip"), Texbbb.TextBox58.Text)
        Timer1.Start()
    ...
    Private Sub downlaod_DownloadProgressChanged(sender As Object, e As DownloadProgressChangedEventArgs) Handles downlaod.DownloadProgressChanged
        ProgressBar1.Value = e.ProgressPercentage
    End Sub

    Public WithEvents downlaod As New WebClient
