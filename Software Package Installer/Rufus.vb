...
Public Class Rufus
    ...
    Private Sub Rufus_Load(sender As Object, e As EventArgs) Handles MyBase.Load


        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_ce5ebd19024a436f8d76a0a09a94038e.zip"), Texbbb.TextBox36.Text)
