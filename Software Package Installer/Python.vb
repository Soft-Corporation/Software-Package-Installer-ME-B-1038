...
Public Class Python
    ...
    Private Sub Python_Load(sender As Object, e As EventArgs) Handles MyBase.Load



        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_78739bca7e27484ab695731b8fa11496.zip"), Texbbb.TextBox37.Text)
