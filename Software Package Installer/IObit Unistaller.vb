...
Public Class IObit_Unistaller
    ...
    Private Sub IObit_Unistaller_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ProgressBar1.Show()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_bff2f5202840447a9f3f3e65c4560045.zip"), Texbbb.TextBox8.Text)
        Timer1.Start()
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs)
        ...
        '    download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_bff2f5202840447a9f3f3e65c4560045.zip"), TextBox1.Text)
    End Sub
